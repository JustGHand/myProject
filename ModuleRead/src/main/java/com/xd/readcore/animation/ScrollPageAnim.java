...
public class ScrollPageAnim extends PageAnimation {
    ...
    private void fillDown(int bottomEdge, int offset) {
        ...
        while (downIt.hasNext()) {
            ...
            // 设置允许显示的范围
            view.updateDestRect(view.top,view.bottom);
            ...
            if (!isRefresh) {
                ...
                if (!hasNext) {
                    ...
                    for (BitmapView activeView : mActiveViews) {
                        ...
                        // 设置允许显示的范围
                        activeView.updateDestRect(activeView.top,activeView.bottom);
...
/*        //设置背景透明
    ...
    public List<BitmapView> getActViews() {
        return mActiveViews;
    }
    ...
    public static class BitmapView {
        ...
        public void updateDestRect(int tarTop, int tarBottom) {
            destRect.top = tarTop;
            destRect.bottom = tarBottom;
        }
