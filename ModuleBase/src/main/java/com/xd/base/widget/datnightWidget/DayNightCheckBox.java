...
public class DayNightCheckBox extends CheckBox {
    ...
    public DayNightCheckBox(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context,attrs);
    }

    public DayNightCheckBox(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
