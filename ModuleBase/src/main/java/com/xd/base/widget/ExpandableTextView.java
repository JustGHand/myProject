...
public class ExpandableTextView extends ConstraintLayout implements View.OnClickListener {
    ...
    private static final int EXPAND_INDICATOR_CONTAINER = 2;
    ...
    public void onClick(View view) {
        ...
        if (mExpandIndicatorController!=null) {
            boolean goon = mExpandIndicatorController.changeState(mCollapsed);
            if (!goon) {
                return;
            }
        }
    ...
    public void setExpandIndicatorController(ExpandIndicatorController controller) {
        mExpandIndicatorController = controller;
    }
    ...
    private static ExpandIndicatorController setupExpandToggleController(@NonNull Context context, TypedArray typedArray) {
        ...
        switch (expandToggleType) {
            ...
            case EXPAND_INDICATOR_TEXT_VIEW:
                ...
                break;
            case EXPAND_INDICATOR_CONTAINER:
                expandIndicatorController = null;
                break;
            default:
    ...
    public interface ExpandIndicatorController {
        boolean changeState(boolean collapsed);
    ...
    static class ImageButtonExpandController implements ExpandIndicatorController {
        ...
        @Override
        public boolean changeState(boolean collapsed) {
