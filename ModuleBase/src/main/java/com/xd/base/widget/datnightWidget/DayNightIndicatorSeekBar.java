...
public class DayNightIndicatorSeekBar extends DayNightSeekBar{
    ...
    public DayNightIndicatorSeekBar(Context context) {
        this(context, null);
    }

    public DayNightIndicatorSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.seekBarStyle);
    }

    public DayNightIndicatorSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        setPadding(mThumbWidth / 2, 0, mThumbWidth / 2, 0);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        // thumb偏移量
        float thumbOffset = (mThumbWidth - mProgressTextRect.width()) / 2 ;
        float thumbX = getWidth() * progressRatio -mProgressTextRect.width()/2;
